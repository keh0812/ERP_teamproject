               ...
               <div class="card-body">
                  <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">출고 현황</li>
                     </ol>
                  </nav>
                  <div class="row">
                     ...
                     <div class="col-xl-12">
                        ...
                        <div id="example" class="mb-9">
                           <h4 class="h1 text-dark"><b>출고 현황</b>
                           ...
                           <div class="mb-3">
                              ...
                              <ul class="nav nav-tabs nav-primary d-block d-xl-flex text-dark"
                                 ...
                                 <li class="nav-item border-bottom border-xl-bottom-0  asss bg-light " ><a
                                    ...
                                    aria-controls="pills-result-1" aria-selected="true">출고 내역</a></li>
                                 <li class="nav-item border-bottom border-xl-bottom-0  asss bg-light"><a
                                    class="nav-link d-flex align-items-center py-2 px-3"
                                    id="pills-html-tab-1" data-toggle="pill"
                                    href="#pills-html-1" role="tab" aria-controls="pills-html-1"
                                    aria-selected="false">출고 전표 등록</a></li>
                              </ul>
                              <!-- End Nav Classic -->
