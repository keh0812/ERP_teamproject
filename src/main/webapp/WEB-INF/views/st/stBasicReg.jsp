                                    ...
                                    <div class="px-3">
                                       <ul id="tabs2" class="nav nav-tabs nav-v2 nav-primary mb-3"
                                          ...
                                          <li class="nav-item"><a
                                             ...
                                             role="tab" aria-selected="true" data-toggle="tab">상품 목록</a></li>
                                          <li class="nav-item ml-4"><a
                                             class="nav-link px-2 pb-2 ass2" href="#tabs2-tab6" onclick="productadd()" role="tab"
                                             aria-selected="false" data-toggle="tab">상품 등록</a></li>
                                       </ul>
                                       <div id="tabsContent2" class="card-body tab-content p-0">
