									...
									<div class="mb-3">
										...
										<ul
											...
											<li
												...
												aria-controls="tabs-result-3" aria-selected="true">회계 전표</a>
											</li>
											<li
												class="nav-item border-bottom border-xl-bottom-0  asss bg-light">
												<a class="nav-link d-flex align-items-center py-2 px-3 "
												id="tabs-html-tab-3" data-toggle="pill" href="#tabs-html-3"
												role="tab" aria-controls="tabs-html-3" aria-selected="false">급여
													전표</a>
											</li>
											<li
												class="nav-item border-bottom border-xl-bottom-0  asss bg-light">
												<a class="nav-link d-flex align-items-center py-2 px-3 "
												id="tabs-html-tab-4" data-toggle="pill" href="#tabs-html-4"
												role="tab" aria-controls="tabs-html-4" aria-selected="false">채권
													채무 전표</a>
											</li>
										</ul>
										<!-- End Nav Classic -->
										...
										<div class="tab-content bg-lighter" id="tabs-tabContent-3">
													...
													<div id="tabsContent2" class="card-body tab-content p-3">
														<div class="tab-pane fade show active" id="tabs2-tab1"
															...
															<div class="row">
																...
																<table
																	class="table bg-white text-dark center ass2 table-striped">

																	<thead class="text-white table-bordered tap">
																		<tr>
																			<th
																				class="font-weight-semi-bold border-top-0 py-3 con2">전표번호</th>
																			<th
																				class="font-weight-semi-bold border-top-0 py-3 con2">전표종류</th>
																			<th
																				class="font-weight-semi-bold border-top-0 py-3 con2">담당자</th>
																	...
																	<tbody>
																		...
																		<c:forEach var="vo" items="${statement}">
																			<c:if test="${vo.accs_state == 1 || vo.accs_state == 3 || vo.accs_state == -1}">
																				...
																				<tr>
																					<td class="py-3 ">
																							<a class="text-dark con2" data-toggle="collapse" style="font-size:22px"
																								...
																								onclick="content(${vo.accs_code})"> ${vo.accs_code}</a>
																					</td>
																					<c:if test="${vo.accs_type == 1 }">
																						<td class="py-3 " style="vertical-align: middle">판매
																							전표</td>
																					</c:if>
																					<c:if test="${vo.accs_type == 2 }">
																						<td class="py-3 " style="vertical-align: middle">채권
																							전표</td>
																					</c:if>
																					<c:if test="${vo.accs_type == 3 }">
																						<td class="py-3 " style="vertical-align: middle">구매
																							전표</td>
																					</c:if>
																					<c:if test="${vo.accs_type == 4 }">
																						<td class="py-3 " style="vertical-align: middle">채무
																							전표</td>
																					</c:if>
																					...
																					<td class="py-3 " style="vertical-align: middle"><fmt:formatDate
																							...
																							pattern="yyyy-MM-dd" value="${vo.accs_update_date}" /></td>
																					<c:if test="${vo.accs_state == 1 || vo.accs_state == 3}">		
																					<td class="py-3 " style="vertical-align: middle">승인완료</td>
																					</c:if>
																					<c:if test="${vo.accs_state == -1}">		
																					<td class="py-3 " style="vertical-align: middle">승인거부</td>
																					</c:if>
																				</tr>
																			</c:if>
																	...
																	<thead class="text-white table-bordered tap">
																		<tr>
																			...
																			<th
																				class="font-weight-semi-bold border-top-0 py-3 con2">담당자</th>
																			<th
																				class="font-weight-semi-bold border-top-0 py-3 con2">등록일</th>
																			<th
																				class="font-weight-semi-bold border-top-0 py-3 con2">승인상태</th>
																		</tr>
																	</thead>
																	<tbody>
																		<c:forEach var="vo" items="${statement}">
																				...
																				<tr>
																					<td class="py-3 ">
																							<a class="text-dark con2"
																								...
																								onclick="content1(${vo.accs_code})">${vo.accs_code}</a>
																					</td>
																					<c:if test="${vo.accs_type == 1 }">
																						<td class="py-3 " style="vertical-align: middle">판매
																							전표</td>
																					...
																					<td class="py-3 " style="vertical-align: middle"><fmt:formatDate
																							pattern="yyyy-MM-dd" value="${vo.accs_reg_date}" /></td>
																					<td class="py-3 " style="vertical-align: middle">대기중
																					</td>
																				</tr>
																			</c:if>
																		</c:forEach>
																	...
																	<table
																		...
																		<thead class="text-white table-bordered tap">
																			<tr>
																				...
																				<th class="font-weight-semi-bold border-top-0 py-3 con2">총급여</th>
																			...
																			<c:forEach var="vo" items="${salarystatement}">
																				<c:if test="${vo.ss_state == 1 || vo.ss_state == -1}">
																					<tr>
																						...
																						<td class="py-3" style="vertical-align: middle">
																							<fmt:formatDate pattern="yyyy-MM-dd" value="${vo.ss_sal_date}" />
																						</td>
																			...
																			<c:forEach var="vo" items="${salarystatement}">
																				<c:if test="${vo.ss_state == 0 }">
																					<tr>
																						...
																						<td class="py-3" style="vertical-align: middle">승인대기중</td>
																					</tr>
																				</c:if>
																			</c:forEach>
																		</tbody>
											...
											<div class="tab-pane fade" id="tabs-html-4" role="tabpanel"
                                    aria-labelledby="tabs-html-tab-4">
                                    <div class="tab-pane fade show active" id="tabs-result-4"
                                       role="tabpanel" aria-labelledby="tabs-result-tab-4">
                                       <div class="px-3 p-4">
                                          <ul id="tabs2"
                                             class="nav nav-tabs nav-v2 nav-primary mb-2"
                                             role="tablist">
                                             <li class="nav-item"><a
                                                class="nav-link px-2 pb-2 active ass2"
                                                href="#tabs2-tab5" role="tab" aria-selected="true"
                                                data-toggle="tab">채권 조회 </a></li>
                                             <li class="nav-item ml-4"><a
                                                class="nav-link px-2 pb-2 ass2" href="#tabs2-tab6"
                                                role="tab" aria-selected="false" data-toggle="tab">채무 조회 </a></li>
                                          </ul>
                                          <div id="tabsContent2" class="card-body tab-content p-3">
                                             ...
                                             <div class="tab-pane fade" id="tabs2-tab6"
                                                role="tabpanel">
                                                <div class="row">
                                                   <div class="col">
                                                      <div class="collapse multi-collapse"
                                                   ...
                                                   <table class="table bg-white text-dark center ass2 table-striped">
                                                      ...
                                                      <tbody>
                                                         <c:forEach var="vo" items="${bondDebt}" varStatus="status">
                                                            <c:if test="${vo.accs_type == 4 }">
                                                               <tr>
                                                                <td class="py-3 ">
                                                   <a class="text-dark con2" style="font-size:22px" data-toggle="collapse"
